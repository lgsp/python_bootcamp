class Animal:
    def __init__(self, birth_type="Unknown", appearance="Unknown", blooded="Unkown"):
...
class Reptile(Animal):
    def __init__(self, birth_type="born in an egg or alive", appearance="dry scales", blooded="cold blooded"):
        Animal.__init__(self, birth_type, appearance, blooded)
